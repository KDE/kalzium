...
KalziumPlotWidget::KalziumPlotWidget( double x1, double x2, double y1, double y2, QWidget *parent, const char* name) 
...
void KalziumPlotWidget::setLimits( double x1, double x2, double y1, double y2 ) {
	double X1, X2, Y1, Y2;
...
void KalziumPlotWidget::setSecondaryLimits( double x1, double x2, double y1, double y2 ) {
